...
%\usepackage{tabularx}
\usepackage{ltxtable}                       % Ermöglicht das erstellen von seitenübergreifenden Tabellen mit der tabularx Umgebung
...
\usepackage{booktabs}
%\newcolumntype{Z}{>{\raggedright\let\newline\\\arraybackslash\hspace{0pt}}X}    % Ermöglicht linksbündige Spalten mit Zeilenumbruch in tabularx durch verwenden von Z
