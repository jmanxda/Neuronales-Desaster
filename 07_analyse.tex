...
\begin{figure}[!htb]
    ...
    \caption[Beispiel zur Bestimmung der Lernrate $\alpha$]{Bestimmung der Lernrate $\alpha$ mit dem geringsten Fehler bei einem MLP ohne Bias-Neuron, welches mit dem Backpropagation-Verfahren trainiert wird. \farbig{das ist noch nicht fertig} }
...
Die Abweichung des $RMSE$ sowie des $MAE$-Schätzers zwischen den beiden Lernalgorithmen beträgt 0,361 und 0,486 respektive. Wobei Der LM-Algorithmus jeweils den geringeren Wert aufweist. Die Differenz des $MAPE$ und des $sMAPE$ beträgt 1,697 und 3,091, wobei ebenfalls der LM-Algorithmus den geringeren Wert besitzt. \farbig{Hieraus geht hervor, dass der Levenberg-Marquardt Algorithmus eine bessere Vorhersage trifft als das Backpropagation Verfahren.}\\
