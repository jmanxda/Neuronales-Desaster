...
In Hinblick auf künstliche neuronale Netze wird das assoziative Gedächtnis unterschieden in:
    ...
    Hier unterscheidet sich die Ausgabe von der Eingabe. Wird das Bild eines Fensters eingegeben kann als Ausgabe das Wort "Fenster" erfolgen.\,\citef[F1.2 ff]{Fiesler96}
...
\begin{figure}[!htb]
    ...
    %---------------------------------------------------------------
        %% CCNN
        %-----------------------------------------
        \includestandalone[mode=image|tex,trim=0pt 0pt 0pt .9cm,clip]{Bilder/Netzwerke/CCNN}
