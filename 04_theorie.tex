...
Im allgemeinen können NN anhand der folgenden vier Kriterien charakterisiert werden\fcite[7 ff]{characterisation_4}:%
...
\item[\textbf{$\bullet$}]%
Unsupervised learning (unüberwachtes Lernen): Wird auch als selbstorganisiertes (self organized) Lernen bezeichnet. Die Trainingsbeispiele bestehen hierbei nur aus Eingansinformationen. Das Netzwerk versucht aus den Eingansinformationen selbst Ähnlichkeiten zu erkennen\footref{kriesel55}.
\begin{itemize}
...
\item%
Nach dem \farbig{Ausgabealgorithmus}.
